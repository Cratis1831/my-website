...
export default function Home() {
  return (
    <main>
      <div className="min-h-screen bg-gradient-to-br from-red-500 to-blue-500 flex flex-col items-center justify-center">
        ...
        <div className="text-md font-normal text-white flex gap-4">
          <Link
